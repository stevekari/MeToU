    ...
    <div className="app-shell">
      ...
      <main className="app-main">
        <Routes>
          <Route
            path="/login"
            element={isAuthenticated ? <Navigate to="/friends" replace /> : <Login onLogin={loginUser} />}
          />
          <Route
            path="/register"
            element={isAuthenticated ? <Navigate to="/friends" replace /> : <Register onLogin={loginUser} />}
          />
          <Route
            path="/friends"
            element={
